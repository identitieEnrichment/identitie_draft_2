...
export const allServicesDataActual = [
  {
    title: "Branding",
    Description:
  ...
  },
  {
    ...
    bulletPoints: [
        "Presentations and Pitchbooks", "Product Fact Sheets", "Messaging Playbook", "Objection Handling", "Frequently Asked Questions", "Infographics", "Case Studies and Testimonials"
    ],
    images: [
      {
        src: "https://firebasestorage.googleapis.com/v0/b/identitie-d1dc6.appspot.com/o/branding-optimized.webp?alt=media&token=4a8d0284-5d94-49f8-95bb-f14f24538862",
