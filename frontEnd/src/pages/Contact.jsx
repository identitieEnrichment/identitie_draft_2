					...
					<div>
						...
						<ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
							<li class="flex items-center text-gray-400 hover:text-blue-500 transition-colors duration-300">
								...
								<a
									href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=identitie.enrichment@gmail.com"
									target="_blank"
							...
							<li class="flex items-center text-gray-400 hover:text-blue-500 transition-colors duration-300">
								...
								<a href="tel:+919444543659" class=" text-sm ml-3">
						...
						<ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
							...
							<li class="flex items-center text-gray-400 hover:text-blue-500 transition-colors duration-300">
								...
								<a href="tel:+919952698022" class=" text-sm ml-3">
									<strong>+91 99526 98022</strong>
								</a>
