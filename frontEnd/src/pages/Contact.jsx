        ...
        <div class="border-[.1px] border-gray-600 grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-10 shadow-[0px_30px_120px_30px_rgba(237,30,35,0.2)] rounded-3xl max-w-6xl mt-24 mx-auto bg-[#0d1117] text-[#333] font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-gray-900 before:h-full max-md:before:hidden">
          <div>
            ...
            <form action="https://api.web3forms.com/submit" method="POST">
              <div class="space-y-4 mt-8">
                ...
                <textarea
                  ...
                  class="rounded-xl px-4 py-3 bg-transparent w-full text-sm border-b-2 border-[#333] outline-none focus:border-white text-white h-44"
                ></textarea>
              </div>
              <button
                type="submit"
            ...
            <ul class="mt-4  flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
              <li class="flex items-center text-gray-400 hover:text-blue-500 transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
                  height="16px"
                ...
                >
                  <strong>identitie.ie@gmail.com</strong>
                </a>
              </li>
              <li class="flex items-center text-gray-400 group transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
                  height="16px"
                ...
                >
                  ...
                  <strong class=" text-sm ml-3">     <a className="hover:text-blue-500" href="tel:+919952698022" >+91 99526 98022 </a>  /  <a className="hover:text-blue-500" href="tel:+919444543659" >+91 94445 43659 </a>  </strong>
			...
			<ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
              <a
                href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=identitie.ie@gmail.com"
                target="_blank"
                class="text-current text-sm ml-3 text-gray-400"
              >
                <strong>
                  7/14A, Karpagam Gardens, 1st main road, Adyar 600020
                </strong>
              </a>
            </ul>
          </div>
          <div class="z-10 relative h-full max-md:min-h-[350px]">
            <div>
              <video
                ...
                src="../assets/toOptimize/GetInTouch_Animation_Video.mp4"
              ></video>
            </div>
            {/* <iframe
