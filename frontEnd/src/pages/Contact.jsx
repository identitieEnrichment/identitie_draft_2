...
const Contact = () => {
	return (
		<div className="bg-black py-3">
			<div class="border-[.1px] border-gray-600 grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-10 shadow-[0px_30px_120px_30px_rgba(119,62,199,0.3)] rounded-3xl max-w-6xl mx-auto bg-[#0d1117] text-[#333] font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-gray-500 before:h-full max-md:before:hidden">
				<div>
					...
					<form action="https://api.web3forms.com/submit" method="POST">
						<div class="space-y-4 mt-8">
							...
							<textarea
								...
								class="rounded-xl px-4 py-3 bg-transparent w-full text-sm border-b-2 border-[#333] outline-none focus:border-white text-white h-44"></textarea>
						</div>
						<button
							type="submit"
							class="rounded-full px-4 py-3 bg-transparent w-full text-sm border-b-2 border-[#333] outline-none focus:border-white text-white flex justify-center items-center mt-4">
							<svg
					...
					<ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
						<li class="flex items-center hover:text-blue-500">
							...
							<a
								href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=binbookskerala@gmail.com"
								target="_blank"
								class="text-current text-sm ml-3">
								<strong>identitie.enrichment@gmail.com</strong>
							</a>
						</li>
						<li class="flex items-center text-current hover:text-blue-500">
							...
							<a href="tel:8882192787" class="text-current text-sm ml-3">
