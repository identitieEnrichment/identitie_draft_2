            ...
            >
              <picture className="w-6/12 ">
                ...
                <img
                  className={`object-cover lg:rounded-xl  ${
                    ...
                    isLastCard
                      ? "lg:h-full h-full w-full"
                      : "h-full w-full md:w-[35vw]"
                  }`}
                  src={images[0].src}
                  alt="im"
                />
              ...
              {isLastCard && (
                <>
                  ...
                  <div className="	absolute inset-0   px-2 w-full h-full flex items-center flex-col space-y-2 justify-center">
                    <div className="flex flex-col  items-center">
                      <div className="space-y-3 flex flex-col items-center text-center">
                        <h1 className="text-white  text-xl lg:text-4xl font-bold ">
                          End-to-End Brand Architecture Fulfillment
                        </h1>
                        <h1 className="text-white lg:text-sm text-xs font-medium">
                          From Vision to Execution, We Offer{" "}
                          <span className="flex lg:hidden"></span>a Diverse
