		...
		<div className="flex  justify-center items-center  mt-8 w-full">
			...
			<div className="font-poppins">
				...
				<div className="flex overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_50px,_black_calc(100%-40px),transparent_100%)] space-x-4  group ">
					<div className=" font-roboto grayscale  font-bold text-xl flex  space-x-4 pt-2 opacity-100 pb-7 group-hover:paused items-center flex-wrap justify-center md:flex-nowrap gap-x-3 gap-y-5">
