	...
	return (
		<div className="flex justify-center items-center md:mt-20 md:absolute bottom-3 md:bottom-4 mt-8 w-full md:left-[90%]">
			...
			<div className="md:max-w-[38rem] max-w-full">
				<div className="flex overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)] space-x-4 md:mx-16 group text-[#ffffff]">
