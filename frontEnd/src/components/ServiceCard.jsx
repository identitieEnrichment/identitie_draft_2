	...
	return (
		<motion.div
			...
			<motion.div
				...
				className={` ${isLastCard?"lg:p-0" : "lg:p-8"}  rounded-lg overflow-hidden drop-shadow-lg shadow-lg lg:shadow-none lg:drop-shadow-none  lg:flex lg:flex-col relative top-[-25%] h-[500px] lg:w-[1000px] rounded-lg origin-top lg:border-[0.1px] lg:border-gray-600 `
			}>
...
>
				...
				<div className={`  w-full lg:h-full   gap-12 ${isLastCard?"lg:block h-full rounded-lg":"lg:flex lg:mt-12 h-[40%]"} `}>
					<div className={`relative w-full lg:${isLastCard?"w-full ": "w-[60%] "}  h-full   lg:rounded-lg overflow-hidden`}>
						<motion.div
							...
							<img
								className={`object-cover   w-full lg:rounded-lg ${isLastCard?"lg:h-full h-full " : "h-80"}`}
								src={`/images/${src}`}
								alt="im"
							/>
							{isLastCard && (
								...
								<div className="	absolute inset-0 w-full h-full flex items-center flex-col space-y-2 justify-center">
									<div className="flex flex-col items-center">
										...
										<button class="text-white  mt-10 hover:before:bg-[#773ec7] rounded-full relative h-[40px] w-40 overflow-hidden border border-white bg-transparent px-3 text-white shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[#773ec7] before:transition-all before:duration-500 hover:text-white hover:shadow-[#773ec7] hover:before:left-0 hover:before:w-full ">
