  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`  w-full lg:h-full   gap-12 ${
            isFirstCard ? " h-full rounded-lg" : " h-[40%]"
          } ${
            isLastCard
              ? "lg:block h-full rounded-lg"
              : "lg:flex lg:mt-12 h-[40%]"
          } `}
        >
          <div
            className={`relative w-full lg:${
              isLastCard ? "w-full " : "w-[60%] "
            }  h-full   lg:rounded-lg overflow-hidden`}
          >
            <motion.div
            ...
            >
              <picture>
                ...
                <img
                  className={`object-cover   w-full lg:rounded-lg  ${
                    isFirstCard ? "h-full lg:h-80" : "h-80"
                  } ${isLastCard ? "lg:h-full h-full " : "h-80"}`}
                  src={`/images/${src}`}
                  alt="im"
                />
              </picture>
          ...
          <div className={`lg:w-[50%] w-full px-4  relative top-[10px]`}>
            ...
            <div className="lg:max-h-[16rem]  overflow-hidden">
