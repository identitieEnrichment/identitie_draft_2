  ...
  return (
    <div className="flex flex-col items-center ">
      <button
        ...
        onClick={scrollToTop}
        className=" justify-end opacity-0  lg:w-fit hidden mt-12    text-white fixed z-50 bottom-[20%] right-6 lg:right-6"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className=" justify-end opacity-0  lg:w-fit hidden mt-12    text-white fixed z-50 bottom-[14%] lg:bottom-[12%] right-6 "
      >
        <img
          className="lg:size-[60px] size-10 object-contain"
          src="../assets/non-optimized/whatsapp_red.png"
          alt=""
        />
      </a>
    </div>
